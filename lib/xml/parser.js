...
function getCorrectDate(vdate, origTimezone) {
    // if (vdate) {
    //     const tz = origTimezone ? origTimezone : vdate.timezone;
    //     const offset = tz && tz!=='Z'?
    //         moment.tz(tz).utcOffset() : tz==='Z' ? 0 : - new Date().getTimezoneOffset();
    //     return moment.unix(vdate.toUnixTime()).subtract(offset, "m").toDate();
    // }
